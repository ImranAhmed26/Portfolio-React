export const projects = [
  ...
  {
    title: 'Quiz Tank',
    description: "This is a online quiz taking project of mine which I started developing as a hobby ",
      image: '/images/3.jpg',
      tags: ['React JS', 'Node JS','Tailwind CSS'],
    source: 'https://github.com/ImranAhmed26/Quiz-Tank',
    visit: 'https://quiz-tank.vercel.app/',
    id: 2,
  },
  {
    title: 'Business Interaspect ',
    description: "I worked on this landing page for a BPO company that goes by the name Business Interaspect",
    image: '/images/4.jpg',
    tags: ['React','Next JS', 'Tailwind CSS'],
